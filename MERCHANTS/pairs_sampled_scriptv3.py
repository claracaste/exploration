...
# %%
path_new_file = "s3://cleo-data-science/transaction_enrichment/experimental_data/caste/processed_duplicates/trans_2024-05-18_2024-05-18"
...
# %%
top_n = 1
merchants_top_n = df_merchant_volume['merchant_name_combined'].tolist()
...
sampled_df = df_top.groupby('merchant_name_combined').apply(lambda x: x.sample(min(len(x), 3*n_pairs))).reset_index(drop=True)
